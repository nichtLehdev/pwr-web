          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <span className="text-sm font-semibold opacity-90">
                {event.type === 'course' ? eventData.courseType : eventData.category}
              </span>
          ...
          {event.type === 'course' && (
            <>
              {eventData.prerequisites && (
                <div>
                  <h3 className="font-semibold text-dark mb-2">Voraussetzungen</h3>
              ...
              {eventData.spotsAvailable !== undefined && (
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="flex items-center justify-between">
                    <span className="font-semibold text-dark">Verfügbare Plätze</span>
