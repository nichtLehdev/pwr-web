    ...
    <footer className="bg-dark text-white">
      ...
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          {/* Über uns */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-primary">Über uns</h3>
          ...
          {/* Mitmachen */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-primary">Mitmachen</h3>
            <ul className="space-y-2">
          ...
          {/* Ressourcen */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-primary">Ressourcen</h3>
            <ul className="space-y-2">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <Link
                  href="/newsletter"
                  className="inline-block text-sm text-primary hover:text-primary-light font-semibold"
                >
