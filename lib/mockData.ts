...
export const mockEnsembles: Ensemble[] = [
  {
    ...
    description: 'Der Landesposaunenchor vereint die besten Bläserinnen und Bläser aus allen Bezirken.',
    isActive: true,
  },
  {
    id: 2,
...
export const mockEvents: Event[] = [
  ...
  },
  {
    ...
    category: 'Concert',
    isFree: false,
    priceOptions: [{ price: 15, label: 'Erwachsene' }, { price: 8, label: 'Ermäßigt' }],
    pendingReview: false,
    approved: true,
    publishedAt: '2025-02-01T10:00:00.000Z',
    createdAt: '2025-01-28T14:20:00.000Z',
...
export const mockCourses: Course[] = [
  {
    ...
    description: '<p>Der D-Kurs ist die erste Stufe der kirchenmusikalischen Ausbildung für Blechbläser.</p>',
  ...
  },
  {
    ...
    allowWaitingList: true,
    priceOptions: [
      { price: 90, label: 'Teilnahmegebühr' }
    ],
    isFree: false,
    customFields: [],
    pendingReview: false,
  ...
  },
  {
    ...
    allowWaitingList: true,
    priceOptions: [
      { price: 280, label: 'Vollpension und Unterkunft' }
    ],
    isFree: false,
    customFields: [],
    pendingReview: false,
...
export const mockPosts: Post[] = [
  {
    ...
    excerpt: 'Die neue Ausgabe des Rheinischen Blechblatts ist da! Mit spannenden Berichten aus den Bezirken.',
    category: 'Magazine',
    districtInfo: { name: 'All Districts' },
    pinned: true,
    pendingReview: false,
  ...
  },
  {
    ...
    excerpt: 'Ab sofort können sich Chöre für das große Landesposaunenfest im Juni anmelden.',
    category: 'Event',
    districtInfo: { name: 'All Districts' },
    pinned: false,
    pendingReview: false,
  ...
  },
  {
    ...
    excerpt: '25 Teilnehmende absolvierten erfolgreich den ersten D-Kurs des Jahres.',
    category: 'Education',
    districtInfo: { name: 'All Districts' },
    pinned: false,
    pendingReview: false,
...
export function getOpenCourses(limit?: number): Course[] {
  const courses = mockCourses
    .filter(c => c.registrationOpen && !c.isFull);
