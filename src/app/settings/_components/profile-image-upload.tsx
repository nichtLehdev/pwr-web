          ...
          <div className="space-y-3">
            <div className="flex flex-col sm:flex-row gap-2">
              <button
                ...
                onClick={handleClick}
                disabled={uploading}
                className="w-full sm:w-auto focus:ring-primary dark:border-dark-border dark:bg-dark-background-secondary dark:text-dark-text dark:hover:bg-dark-background inline-flex items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 focus:ring-2 focus:outline-none disabled:opacity-50"
              >
