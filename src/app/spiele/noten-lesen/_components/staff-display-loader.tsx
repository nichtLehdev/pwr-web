...
const StaffDisplayInner = dynamic(
  () => import("./staff-display").then((m) => ({ default: m.StaffDisplay })),
  {
    ...
    loading: () => (
      ...
      <div className="dark:border-dark-border dark:bg-dark-surface flex min-h-[200px] items-center justify-center rounded-sm border border-gray-200 bg-gray-50 md:min-h-[240px]">
