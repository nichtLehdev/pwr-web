  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-dark-background">
      <div className="container mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        {/* Quick Links */}
        <section className="border-t border-gray-200 pt-8 dark:border-dark-border">
          <h2 className="mb-4 text-lg font-semibold text-gray-900 dark:text-dark-text">
            Schnellzugriff
          </h2>
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-6">
            <QuickLink title="Einstellungen" href="/settings" icon={<CogIcon />} />
            <QuickLink title="Zur Webseite" href="/" icon={<HomeIcon />} />
            <QuickLink title="Termine" href="/termine" icon={<CalendarIcon />} />
            <QuickLink title="Aktuelles" href="/aktuelles" icon={<DocumentTextIcon />} />
            <QuickLink title="Über uns" href="/ueber-uns" icon={<InformationCircleIcon />} />
            <QuickLink title="Hilfe" href="/kontakt" icon={<QuestionMarkCircleIcon />} />
          </div>
        </section>
      </div>
    </main>
...
function DashboardCard({
  ...
  const content = (
    <div
      className={`group relative flex h-full flex-col rounded-xl border bg-white p-5 transition-all dark:bg-dark-surface ${
        comingSoon
          ? "cursor-not-allowed border-gray-200 opacity-60 dark:border-dark-border"
          : "border-gray-200 hover:border-primary hover:shadow-lg dark:border-dark-border dark:hover:border-primary"
      }`}
    >
      {comingSoon && (
      ...
      <div
        className={`mb-3 flex h-10 w-10 items-center justify-center rounded-lg text-primary ${
          comingSoon ? "bg-gray-100 dark:bg-dark-border" : "bg-primary/10 group-hover:bg-primary group-hover:text-white"
        } transition-colors`}
      >
        {icon}
      </div>
...
function QuickLink({
  ...
  return (
    <Link
      href={href}
      className="flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-700 transition-all hover:border-primary hover:text-primary dark:border-dark-border dark:bg-dark-surface dark:text-dark-text dark:hover:border-primary dark:hover:text-primary"
    >
