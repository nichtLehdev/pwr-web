            ...
            {!isHigherRole && userBezirkId ? (
              ...
              <div className="rounded-lg bg-yellow-50 p-4 dark:bg-yellow-900/20">
                <p className="text-sm text-yellow-800 dark:text-yellow-300">
                  ...
                  Bitte wende dich an einen Administrator, um Termine erstellen
                  zu können.
                </p>
              </div>
            ) : (
              ...
              <div className="space-y-3">
                ...
                <label className="flex cursor-pointer items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Der Termin wird noch nicht veröffentlicht und ist nur für
                      dich sichtbar.
                    </p>
                  </div>
                </label>
              ...
              <>
                <label className="flex cursor-pointer items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Der Termin wird noch nicht zur Prüfung eingereicht und ist
