...
export function BulkInvoiceModal({
  ...
  return (
    <ScrollableModal>
      <ScrollableModalCard maxW="md" className="relative">
        {/* Close Button */}
        <button
          onClick={handleClose}
          disabled={isGenerating}
          className="absolute top-4 right-4 z-10 rounded-full p-1 text-gray-400 hover:bg-gray-100 hover:text-gray-600 disabled:opacity-50"
        >
          <X className="h-5 w-5" />
        </button>
