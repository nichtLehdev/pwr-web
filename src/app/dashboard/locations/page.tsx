...
export default function DashboardLocationsPage() {
  ...
  const isInitialLocationsLoad =
    locationsLoading && locationsData === undefined;

  if (isPending || profileLoading || isInitialLocationsLoad) {
    return (
  ...
  return (
    ...
    >
      ...
      <div
        className={
          locationsFetching && !isInitialLocationsLoad
