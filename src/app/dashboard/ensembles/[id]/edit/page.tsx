...
export default function EditEnsemblePage() {
  ...
  return (
    <>
      <DashboardPage
        title="Ensemble bearbeiten"
        description="Bearbeite die Informationen des Ensembles"
        breadcrumbs={[
          { label: "Dashboard", href: "/dashboard" },
          { label: "Ensembles", href: "/dashboard/ensembles" },
          { label: ensemble.name, href: `/dashboard/ensembles/${ensembleId}` },
          { label: "Bearbeiten" },
        ]}
        maxWidth="7xl"
      >
