...
export const metadata = {
  ...
  description: "Impressum und rechtliche Informationen des Posaunenwerks Rheinland",
};
              ...
              <div className="space-y-6">
                ...
                <div className="dark:border-dark-border border-t border-gray-200 pt-6">
                  ...
                  <p className="mb-2 text-gray-700 dark:text-gray-300">
                    Bei technischen Fragen zur Website wenden Sie sich bitte an unser Internet-Team:
                  </p>
                  <a
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl">
            <div className="dark:bg-dark-surface dark:border-dark-border rounded-lg bg-white p-6 shadow-lg md:p-8 dark:border dark:shadow-none">
              ...
              <div className="space-y-6">
                <p className="text-gray-700 dark:text-gray-300">
                  Diese Website nutzt verschiedene Open-Source-Softwarepakete. Wir möchten den
                  Entwicklern dieser Projekte für ihre großartige Arbeit danken. Im Folgenden finden
                  Sie eine Übersicht der verwendeten Hauptkomponenten und deren Lizenzen:
                </p>
                ...
                <div className="dark:border-dark-border mt-6 rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border dark:bg-gray-800/30">
                  ...
                  <p className="mb-3 text-sm text-gray-600 dark:text-gray-400">
                    Diese Website nutzt zahlreiche weitere Open-Source-Pakete. Alle verwendeten
                    Bibliotheken und deren vollständige Lizenzinformationen finden Sie in unserer{" "}
                  ...
                  <ul className="mt-2 space-y-1 text-sm text-gray-600 dark:text-gray-400">
                    <li className="flex items-center gap-2">
                      ...
                      <strong>MIT License</strong> - Erlaubt kommerzielle Nutzung, Modifikation und
                      Verteilung
                    </li>
                    <li className="flex items-center gap-2">
                      <svg
                      ...
                      <strong>Apache License 2.0</strong> - Erlaubt Nutzung, Modifikation und
                      Verteilung mit Patentrechtsgewährung
                    </li>
                    <li className="flex items-center gap-2">
                      <svg
                        className="text-primary h-4 w-4"
                      ...
                      <strong>BSD-2-Clause</strong> - Permissive Lizenz mit minimalen
                      Einschränkungen
                    </li>
                    <li className="flex items-center gap-2">
                      <svg
                      ...
                      <strong>0BSD</strong> - "Zero-Clause" BSD-Lizenz, Public Domain äquivalent
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="dark:bg-dark-surface dark:border-dark-border rounded-lg bg-white p-6 shadow-lg md:p-8 dark:border dark:shadow-none">
              ...
              <div className="space-y-6">
                ...
                <div className="dark:border-dark-border border-t border-gray-200 pt-6">
                  ...
                  <p className="mb-3 text-gray-700 dark:text-gray-300">
                    Bei Fragen oder Anregungen zu dieser Website oder unserem Angebot stehen wir
                ...
                <div className="dark:border-dark-border border-t border-gray-200 pt-6">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Die auf dieser Website verwendeten Bilder sind, sofern nicht anders angegeben,
                    Eigentum des Posaunenwerks Rheinland oder wurden mit entsprechender Erlaubnis
                    zur Nutzung bereitgestellt. Bildnachweise werden, wo erforderlich, direkt bei
      ...
      <section className="bg-background-secondary dark:bg-dark-background-secondary py-8">
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Stand dieser Impressumsangaben: November 2025
            </p>
          </div>
        </div>
      </section>
