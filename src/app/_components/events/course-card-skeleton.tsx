export default function CourseCardSkeleton() {
  return (
    <article className="flex animate-pulse gap-3 rounded-lg bg-white p-4 shadow-md transition-shadow hover:shadow-lg">
      {/* Date Range Badge Skeleton (wider for multi-day) */}
      <div className="h-12 min-w-20 shrink-0 rounded-lg bg-gray-200"></div>
