      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Text style={heading}>Newsletter-Anmeldung bestätigen</Text>
            ...
            <Text style={paragraph}>
              ...
              Rheinland angemeldet. Bitte bestätige die Anmeldung mit einem
              Klick — erst danach schicken wir dir den Newsletter.
            </Text>
            ...
            <Text style={footer}>
              Du hast dich nicht angemeldet? Dann ignoriere diese E-Mail
              einfach. Ohne deine Bestätigung versenden wir nichts an diese
              Adresse, und die Anmeldung verfällt von selbst.
            </Text>

            <Text style={footer}>Dieser Link ist 7 Tage gültig.</Text>
          </Section>
