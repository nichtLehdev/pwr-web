/**
 * EPC QR payload (BCD 002) for a SEPA credit transfer ("GiroCode"). Dependency-free:
 * invoice PDF, registration form and confirmation mail each use their own renderer.
 */
